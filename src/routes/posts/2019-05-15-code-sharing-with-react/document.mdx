This blog is meant for best practise and lessons learnt on this subject.
...
# What we done differently

## Customize-CRA

We are using https://github.com/arackaf/customize-cra instead of manually creating `config-overrides.js`
for better readability and maintainability.

[config-overrides.js](https://github.com/brunolemos/react-native-web-monorepo/blob/master/packages/web/config-overrides.js) can be replaced by
